...
class _$Thumbnails extends Thumbnails {
  @override
  final Thumbnails default_;
  @override
  final Thumbnails medium;
  @override
  final Thumbnails high;
...
class ThumbnailsBuilder implements Builder<Thumbnails, ThumbnailsBuilder> {
  ...
  ThumbnailsBuilder _default_;
  ThumbnailsBuilder get default_ =>
      _$this._default_ ??= new ThumbnailsBuilder();
  set default_(ThumbnailsBuilder default_) => _$this._default_ = default_;

  ThumbnailsBuilder _medium;
  ThumbnailsBuilder get medium => _$this._medium ??= new ThumbnailsBuilder();
  set medium(ThumbnailsBuilder medium) => _$this._medium = medium;

  ThumbnailsBuilder _high;
  ThumbnailsBuilder get high => _$this._high ??= new ThumbnailsBuilder();
  set high(ThumbnailsBuilder high) => _$this._high = high;
