...
class _$ThumbnailSerializer implements StructuredSerializer<Thumbnail> {
  ...
  Iterable<Object> serialize(Serializers serializers, Thumbnail object,
    ...
    final result = <Object>[
      ...
      'hheight',
      serializers.serialize(object.hheight, specifiedType: const FullType(int)),
    ];
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'width':
          ...
          break;
        case 'hheight':
          result.hheight = serializers.deserialize(value,
              specifiedType: const FullType(int)) as int;
          break;
      }
    }
...
class _$Thumbnail extends Thumbnail {
  ...
  _$Thumbnail._({this.url, this.width, this.hheight}) : super._() {
    if (url == null) {
    ...
    if (hheight == null) {
      throw new BuiltValueNullFieldError('Thumbnail', 'hheight');
    }
  }
  ...
  bool operator ==(Object other) {
    ...
    return other is Thumbnail &&
        url == other.url &&
        width == other.width &&
        hheight == other.hheight;
  }

  @override
  int get hashCode {
    return $jf(
        $jc($jc($jc(0, url.hashCode), width.hashCode), hheight.hashCode));
  }
...
class ThumbnailBuilder implements Builder<Thumbnail, ThumbnailBuilder> {
  ...
  int _hheight;
  int get hheight => _$this._hheight;
  set hheight(int hheight) => _$this._hheight = hheight;
  ...
  _$Thumbnail build() {
    final _$result =
        _$v ?? new _$Thumbnail._(url: url, width: width, hheight: hheight);
    replace(_$result);
    return _$result;
  }
}
